...
const error_1 = require("@frontity/error");
/**
...
class FrontityURL extends URL {
    ...
    constructor(input, base) {
        (0, error_1.warn)("Importing `URL` from Frontity has been deprecated. Please use `new URL()` instead.");
        // Calling `new URL("http://some.url", undefined)` fails in Sarafi.
        base ? super(input, base) : super(input);
    }
}
exports.default = FrontityURL;
